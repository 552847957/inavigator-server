...
<%
    ...
    String modileLogs    = "MOBILE_LOGS".equals(pageType)?    "selected"  : "";
        ...
        <table width="100%" border="0">
            <tr>
                <td width="1" class="menuIcon">
                    <a title="Настройки" class="menu <%=databaseClass%>" href="apps.clientproperties.gui">
                        <br/>
                        <br/>
                        <br/>
                        <br/>
                ...
                <td width="1" class="menuIcon">
                	...
                	<br/>
						<ul id="nav">
							<li><a class="menu <%=modileLogs %>" href="#">Еще..</a>
								<ul>
									<li><a title="Логи" class="menu <%=modileLogs %>" href="mode.mobile.gui">Логирование</a></li>
