...
<%
    ...
    String monitor    = "ONLINE_MONITOR".equals(pageType)?    "selected"  : "";
%>
        ...
        <table width="100%" border="0">
            <tr>
                ...
                <td width="1" class="menuIcon">
                	...
                	<br/>
						<ul id="nav">
							<li><a class="menu <%=audit %><%=monitor %>" href="#">Еще..</a>
								<ul>
									<li><a title="Аудит" class="menu <%=audit %>" href="log.audit.gui">Аудит</a></li>
									<li><a title="Онлайн мониторинг" class="menu <%=monitor %>" href="show.online-monitor.gui">Онлайн мониторинг</a></li>
									<li><a title="Режим тех. поддержки" class="menu" href="form.maintenance.gui">Режим тех. поддержки</a></li>
									<li><a title="Статусы чекеров" class="menu" href="show.checkers.gui">Статусы чекеров</a></li>
								</ul></li>
						</ul>
					</td>
