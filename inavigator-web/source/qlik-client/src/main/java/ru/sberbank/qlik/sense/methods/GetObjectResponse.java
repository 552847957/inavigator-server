...
public class GetObjectResponse extends BaseResponse<GetObjectResponse.Result> {
    ...
    public static class QReturn {
        ...
        public String getqGenericType() {
            return qGenericType;
        }

        public void setqGenericType(String qGenericType) {
